...
**DClaw Quality** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8047` (FastAPI)
- **Frontend Port:** `3047` (Next.js)
- **Database:** `dclaw_quality` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3047`
